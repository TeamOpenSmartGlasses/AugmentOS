...
def load_frequency_list(language_code: str, type: str) -> pd.DataFrame:
    ...
    file_path = os.path.join("../../../server/word_frequency_lists/content/2018", folder_name, f"{folder_name}_{type}.txt")
...
def get_word_frequency_percentiles(words: List[str], language_code: str) -> dict:
