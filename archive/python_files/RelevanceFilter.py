...
class RelevanceFilter:
    def __init__(self, db_handler):
        ...
        self.banned_terms = ["LOL", "AI", "Caden Pierce", "Alex Israel", "Professor", "God", "Jesus", "Google",
                             "David Newman", "Patty", "Earth", "North America", "United States", "Special Boat Service", "League of Legends"]
