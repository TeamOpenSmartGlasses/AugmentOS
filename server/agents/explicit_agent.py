...
llm = get_langchain_gpt4o(max_tokens=150)
...
explicit_agent_prompt_blueprint = """[Your Task]
...
NOTE: If the query is empty or nonsensical, return "Final Answer: No query provided."
"""
...
#The Search_Engine is not for personal data queries! It will only search the web, don't use it if the user asks a query about their personal data or conversation, only use it to retrieve information from the web.
# Example:
