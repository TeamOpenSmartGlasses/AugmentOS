...
async def expert_agent_arun_wrapper(expert_agent_config, convo_context, insights_history: list):
    #run the agent
    return await agent.arun(expert_agent_prompt_maker(expert_agent_config, convo_context, insights_history))
  

def expert_agent_run_wrapper(expert_agent_config, convo_context, insights_history: list):
    #run the agent
    return agent.run(expert_agent_prompt_maker(expert_agent_config, convo_context, insights_history))
