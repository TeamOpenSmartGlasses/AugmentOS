# Takes in a Chrome or Brave (probably works with Firefox too) bookmarks export HTML
# file and spits out CSV for CSE python3 parse_bookmarks.py <name of my file>.html
