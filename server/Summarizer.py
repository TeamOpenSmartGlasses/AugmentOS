...
class Summarizer:
    ...
    def summarize_entity(self, entity_description: str, chars_to_use=1250):
        ...
        summary = self.summarize_entity_with_openai(entity_description, chars_to_use)
        self.databaseHandler.saveCachedSummary(entity_description, summary)
        return summary

    def summarize_entity_with_openai(self, entity_description: str, chars_to_use=1250):
